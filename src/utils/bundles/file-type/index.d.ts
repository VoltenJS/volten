...
interface IGetToken<Value, Array extends Uint8Array = Uint8Array> {
  len: number;
...
*/
type AnyWebReadableStream<G> = ReadableStream$1<G> | ReadableStream<G>;
...
*/
declare function fileTypeFromBuffer(
...
*/
declare function fileTypeFromStream(
...
```
*/
declare function fileTypeFromTokenizer(
...
*/
declare const supportedExtensions: ReadonlySet<string>;

/**
Supported MIME types.
*/
declare const supportedMimeTypes: ReadonlySet<string>;
...
```
*/
declare function fileTypeFromBlob(
  blob: Blob,
  options?: FileTypeOptions,
): Promise<FileTypeResult | undefined>;
...
declare class TokenizerPositionError extends Error {
...
*/
declare function fileTypeFromFile(
  filePath: string,
  options?: FileTypeOptions,
): Promise<FileTypeResult | undefined>;
...
*/
declare function fileTypeStream(
