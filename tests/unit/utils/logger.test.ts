...
test("Logger Unit Tests", async (t) => {
  await t.test("default initialization and baseline logs", () => {
  ...
  await t.test("level thresholds and custom level name validation", () => {
  ...
  await t.test("dynamic level set and get", () => {
  ...
  await t.test("custom levels option", () => {
  ...
  await t.test("baseContext, mixin, and dynamic mixin inclusion", () => {
    const mixinFn = () => ({
      dynamicVal: "dynamic",
  ...
  await t.test("timestamp option configurations", () => {
  ...
  await t.test("serializers application", () => {
    const logger = createLogger({
      serializers: {
  ...
  await t.test("error argument handling", () => {
    const logger = createLogger();
  ...
  await t.test("object argument handling and formatting", () => {
    const logger = createLogger();
    const logs = captureLogs(() => {
  ...
  await t.test("string argument formatting", () => {
    const logger = createLogger();
    const logs = captureLogs(() => {
  ...
  await t.test("other data types in firstArg", () => {
    const logger = createLogger();
    const logs = captureLogs(() => {
  ...
  await t.test("redaction of keys", () => {
  ...
  await t.test("pretty printing configuration", () => {
  ...
  await t.test("child loggers creation and property inheritance", () => {
    const logger = createLogger({
      level: "debug",
  ...
  await t.test("handles invalid current level name during initialization fallback", () => {
    const logger = createLogger({
  ...
  await t.test("isLevelEnabled returns false for invalid levels", () => {
    const logger = createLogger();
